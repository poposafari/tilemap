...
def extract(file_number: str, overworld_type:str,tile_type: str):
    input_path = f"./before/{overworld_type}{file_number}.json"
    output_path = f"./after/{overworld_type}{file_number}.json"
    ...
    extracted_tilesets = []
    for key in TILE:
        tile_file = f"./json/{tile_type}/{key}.json"
...
if __name__ == "__main__":
    ...
    overworld_type = input("plaza? safari?(p or s)").strip()
